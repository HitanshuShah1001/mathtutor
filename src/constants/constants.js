...
// Define your filter option arrays at the top of your file
...
export const examYears = [2018, 2019, 2020, 2021, 2022, 2023, 2024];

export const shifts = ["shift1", "shift2", "shift3"];

export const streams = ["science", "commerce"];
...
export const types = ["archive", "custom", "autoGenerated"];
export const difficulties = ["easy", "medium", "hard"];
export const INVALID_TOKEN = "Invalid or expired access token";
